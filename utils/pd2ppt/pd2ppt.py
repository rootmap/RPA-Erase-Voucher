...
class DataFrame2PPT:
    ...
    def _do_formatting(self, value, format_str):
    ...
    def process_position_parameter(self, param):
    ...
    def df_to_table(self, slide, df, left=None, top=None, width=None, height=None,
        ...
        """
        left = self.process_position_parameter(left)
        top = self.process_position_parameter(top)
        width = self.process_position_parameter(width)
        height = self.process_position_parameter(height)
        ...
        for row in range(rows):
            for col in range(cols):
                ...
                if col_formatters is None:
                    ...
                    text = self._do_formatting(val, col_formatters[col])
    ...
    def df_to_powerpoint(self, filename, df, **kwargs):
        ...
        **kwargs
        ...
        table = self.df_to_table(slide, df, **kwargs)
        pres.save(filename)
